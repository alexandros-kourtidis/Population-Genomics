...
final_plot <- wrap_plots(all_population_plots, ncol = 1)

# Save the final combined plot
ggsave(filename = paste0(OUT_DIR, "/all_populations_combined_sf2_nolabels_colours.png"), plot = final_plot,
