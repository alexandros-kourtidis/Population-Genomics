...
#SBATCH --array=1-98  # Adjust this to match the number of samples (97 D1-5 + 1 CN_W1_1)
...
samples=($(cat /vsc-hard-mounts/leuven-data/363/vsc36396/scripts/04_genotyping/batch1234CN_list_sequence_A_F_CN.txt))
