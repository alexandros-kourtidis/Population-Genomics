...
cd /lustre1/scratch/363/vsc36396/daphnia_reseq/DNA_Daphnia_reseq_batch1
 
#For making sure that the txt file created on Windows is used in a Unix-like environment:
#dos2unix /vsc-hard-mounts/leuven-data/363/vsc36396/scripts/batch1_list.txt
 
#Path to the renaming file
RENAME_FILE= /vsc-hard-mounts/leuven-data/363/vsc36396/scripts/batch1_list.txt
